...
import { authenticateRefresh, authenticateToken, generateToken } from './auth.middleware.js';
...
export const authRoutes = createAuthRouter(authService, authenticateToken, authenticateRefresh);
