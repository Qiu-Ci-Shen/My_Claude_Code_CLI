...
test('Codex synchronizer preserves the title assigned when Qiu_Ai_LZ creates a session', { concurrency: false }, async () => {
  ...
  try {
    ...
    await withIsolatedDatabase(async () => {
      ...
      // exactly as a message sent from the app does.
