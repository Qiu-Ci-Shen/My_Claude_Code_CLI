...
export type ProviderModelOption = {
  ...
  recordId?: number;
  /** True for user-created rows; false for immutable Qiu_Ai_LZ defaults. */
  isCustom?: boolean;
  effort?: {
    default?: string;
    values: {
 ...
 * checked out in the main worktree), last-commit metadata, and the Qiu_Ai_LZ
...
/**
 * Input accepted when registering an existing worktree as a Qiu_Ai_LZ project.
 *
...
/**
 * Project view returned after a worktree is opened in Qiu_Ai_LZ.
 *
